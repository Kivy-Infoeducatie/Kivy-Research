export default function InstallationPage() {
  return (
    <div className='prose prose-indigo max-w-none'>
      ...
      <p>
        Follow these steps to install Kivy and set up your development
        environment.
      </p>
      <h2>Prerequisites</h2>
      <ul>
...
bun dev`}
      ...
      <h2>Configuration</h2>
      <p>
        After installation, you'll need to configure your camera and projector
        settings. Create a <code>.env</code> file in the root directory with the
        following variables:
      </p>
      <pre className='rounded-md bg-gray-100 p-4'>
        <code>
