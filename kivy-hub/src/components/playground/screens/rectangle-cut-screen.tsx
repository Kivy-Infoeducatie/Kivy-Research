...
import { RectangleCutCanvas } from '@/components/playground/widgets/rectangle-cut-canvas';

export function RectangleCutScreen({ active }: { active: boolean }) {
  ...
  return (
    <div className={cn(!active && 'hidden', 'h-screen w-screen')}>
      <RectangleCutCanvas pointARef={pointARef} pointBRef={pointBRef} />
